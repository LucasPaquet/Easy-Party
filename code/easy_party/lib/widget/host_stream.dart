...
import 'package:easy_party/widget/empty_state_host.dart';
import 'package:easy_party/widget/invited_info.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class HostStream extends StatefulWidget {
  const HostStream({Key? key}) : super(key: key);

  @override
  _HostStreamState createState() => _HostStreamState();
}

class _HostStreamState extends State<HostStream> {
